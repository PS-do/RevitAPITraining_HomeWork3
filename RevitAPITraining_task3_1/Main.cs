...
namespace RevitAPITraining_task3_1
{
    ...
    public class Main : IExternalCommand
    {
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            IList<Reference> selectedElementRefList = uidoc.Selection.PickObjects(ObjectType.Edge, new WallFilter(), "Выберите стены");
            double sumVolume = 0;
            ...
            TaskDialog.Show("Объм стен", $"Суммарный объём выбранных стен: {sumVolume} ");
